...
#include "../../../src/ui/systemtrayicon/systemtrayicon.h"
...
QT_MOC_LITERAL(1, 15, 14), // "signal_showWin"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 14), // "signal_stopApp"
QT_MOC_LITERAL(4, 46, 4), // "type"
QT_MOC_LITERAL(5, 51, 18), // "slot_iconActivated"
QT_MOC_LITERAL(6, 70, 33), // "QSystemTrayIcon::ActivationRe..."
QT_MOC_LITERAL(7, 104, 6), // "reason"
QT_MOC_LITERAL(8, 111, 13) // "slot_app_exit"

    },
    "SystemTrayIcon\0signal_showWin\0\0"
    "signal_stopApp\0type\0slot_iconActivated\0"
    "QSystemTrayIcon::ActivationReason\0"
    "reason\0slot_app_exit"
};
...
void SystemTrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_showWin(); break;
        case 1: _t->signal_stopApp((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 2: _t->slot_iconActivated((*reinterpret_cast< QSystemTrayIcon::ActivationReason(*)>(_a[1]))); break;
        case 3: _t->slot_app_exit(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTrayIcon::signal_showWin)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTrayIcon::signal_stopApp)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SystemTrayIcon::signal_showWin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SystemTrayIcon::signal_stopApp(const int & _t1)
{
