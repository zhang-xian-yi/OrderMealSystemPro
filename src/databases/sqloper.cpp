...
bool SQLoper::createTable(SQLiteTable & table)
{
...
bool SQLoper::execSQL(const QString& sql)
{
    //创建表格
...
bool SQLoper::insertRecord(QString table_name, QVector<QString> values)
{
...
bool SQLoper::deketeRecord(QString table_name, QString p_key,QString uuid)
{
